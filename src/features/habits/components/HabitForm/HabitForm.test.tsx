...
describe('HabitForm', () => {
  ...
  test('renders edit form with initial data', () => {
    ...
    expect(screen.getByRole('textbox', { name: /habit name/i })).toHaveValue('Test Habit');
    ...
    expect(screen.getByRole('combobox', { name: /frequency/i })).toHaveValue('weekly');
    
    // Check time of day is set
    expect(screen.getByRole('combobox', { name: /time of day/i })).toHaveValue('morning');
  });
  ...
  test('submits form with correct values', async () => {
    ...
    // Fill in the form
    await userEvent.type(screen.getByRole('textbox', { name: /habit name/i }), 'New Test Habit');
    await userEvent.type(screen.getByRole('textbox', { name: /description/i }), 'New description');
